    ...
    <div className="fade-in" style={{ padding: '0', background: '#0f172a', minHeight: '100vh', color: 'white' }}>
      ...
      <div style={{ 
        ...
        <button 
          ...
          className="neon-btn" 
          style={{ padding: '6px 15px', fontSize: '0.75rem', background: isOnDuty ? '#ef4444' : 'var(--accent)' }}
        >
        ...
        <header style={{ marginBottom: '2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '5px' }}>
              <div style={{ width: 24, height: 24, borderRadius: '50%', background: 'var(--accent)', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.7rem' }}>
              ...
              <button onClick={() => setView('profile')} style={{ background: 'none', border: 'none', color: 'var(--accent)', fontSize: '0.75rem', cursor: 'pointer', marginLeft: '5px' }}>[Profil]</button>
            </div>
          </div>
